...
var FullCalendar = (function(e) {
    ...
    function L(e, t, n) {
        ...
        i.__ && i.__(e, t),
            ...
            I(
                ...
                o || c,
                c,
                void 0 !== t.ownerSVGElement, !r && n ? [n] :
                o ?
                null :
                t.firstChild ?
                d.slice.call(t.childNodes) :
                null,
                a, !r && n ? n : o ? o.__e : t.firstChild,
                r
            ),
            P(a, e);
    }
    ...
    function De(e, t) {
        for (
            var n = e instanceof HTMLElement ? [e] : e, r = [], o = 0; o < n.length; o += 1
        )
    ...
    function xt(e, t, n) {
        ...
        for (var l in ((s = St(s, function(e) {
            ...
            if (u.recurringDef) {
                ...
                for (
                    var d = 0, p = Mt(u, c, t, r, o.recurringTypes); d < p.length; d++
                ) {
                    var f = p[d],
    ...
    function Mt(e, t, n, r, o) {
        var i = o[e.recurringDef.typeId].expand(
            e.recurringDef.typeData, { start: r.subtract(n.start, t), end: n.end },
            r
        );
    ...
    function Ht(e) {
        var t = {
                ...
                days: e.days || e.day || 0,
                milliseconds: 60 * (e.hours || e.hour || 0) * 60 * 1e3 +
    ...
    function Vt(e) {
        ...
        return e.days ?
            e.specifiedWeeks && e.days % 7 == 0 ? { unit: "week", value: e.days / 7 } : { unit: "day", value: e.days } :
            e.months ? { unit: "month", value: e.months } :
            e.years ? { unit: "year", value: e.years } : { unit: "millisecond", value: 0 };
    }
    ...
    function En(e, t, n, r) {
        for (
            var o = { defs: {}, instances: {} }, i = An(n), a = 0, s = e; a < s.length; a++
        ) {
    ...
    function Ln(e, t, n, o, i, a) {
        for (
            var s = {
                ...
                l = 0,
                u = a.pluginHooks.eventDefMemberAdders; l < u.length; l++
        ) {
            var c = u[l];
            r(s, c(e));
        }
    ...
    function Wn(e, t) {
        ...
        return (
            e.start && ((n = lt(e.start)), r && r <= n && (r = tt(n, 1))), { start: n, end: r }
        );
    }
    ...
    function yr(e, t) {
        for (
            var n, o, i = {}, a = 0, s = t.pluginHooks.dateSpanTransforms; a < s.length; a++
        ) {
            var l = s[a];
            r(i, l(e, t));
        }
    ...
    function br(e, t, n, o) {
        ...
        for (
            var s = 0, l = o.pluginHooks.eventDefMutationAppliers; s < l.length; s++
        ) {
            (0, l[s])(a, n, o);
        }
    ...
    function Rr(e, t, n) {
        ...
        if (
            ...
            var o = mn(r, n),
                ...
                s = (function(e, t) {
                    for (
                        var n = t.pluginHooks.eventSourceDefs, r = n.length - 1; r >= 0; r -= 1
                    ) {
            ...
            return (
                ...
                (e.prototype.select = function(e, t) {
                    ...
                    n =
                        null == t ?
                        null != e.start ?
                        e : { start: e, end: null } : { start: e, end: t };
        ...
        if (t) {
            ...
            if (vt(n)) {
                ...
                return (
                    ...
                    (r =
                        ("-" === t[15] ? -1 : 1) *
                        (60 * Number(t[16] || 0) + Number(t[18] || 0))), { marker: n, isTimeUnspecified: !t[6], timeZoneOffset: r }
                );
            }
        }
        return null;
            ...
            return (
                ...
                (e.prototype.createMarkerMeta = function(e) {
                    ...
                    return (
                        ...
                        null !== t && vt(t) ? { marker: t, isTimeUnspecified: !1, forcedTzo: null } :
                        null
                    );
                }),
                (e.prototype.parse = function(e) {
                    ...
                    return (
                        ...
                        (this.canComputeOffset ?
                            ...
                            (r = t.timeZoneOffset)), { marker: n, isTimeUnspecified: t.isTimeUnspecified, forcedTzo: r }
                    );
                }),
                ...
                (e.prototype.greatestWholeUnit = function(e, t) {
                    ...
                    return null !== n ? { unit: "year", value: n } :
                        null !== (n = this.diffWholeMonths(e, t)) ? { unit: "month", value: n } :
                        null !== (n = at(e, t)) ? { unit: "week", value: n } :
                        null !== (n = st(e, t)) ? { unit: "day", value: n } :
                        $e(
                            (n = (function(e, t) {
                        ...
                        ) ? { unit: "second", value: n } : { unit: "millisecond", value: t.valueOf() - e.valueOf() };
                }),
                    ...
                    return (
                        ...
                        n.formatRange({
                                ...
                                timeZoneOffset: null != r.forcedStartTzo ?
                                    r.forcedStartTzo : this.offsetForMarker(e),
                            }, {
                                marker: t,
                                timeZoneOffset: null != r.forcedEndTzo ?
                                    r.forcedEndTzo : this.offsetForMarker(t),
                            },
                            this,
                            r.defaultSeparator
                        )
                ...
                var n = [].concat(e || []),
                    ...
                    (function(e, t) {
                        for (var n = 0; n < e.length; n += 1)
                            for (
                                var r = e[n].toLocaleLowerCase().split("-"), o = r.length; o > 0; o -= 1
                            ) {
    ...
    function so(e, t, n, o) {
        ...
        if (a.navLinks) {
            ...
            return r({ title: Xe(a.navLinkHint, [l, u], l), "data-navlink": "" },
                o ? He(c) : { onClick: c }
            );
        }
        return { "aria-label": l };
    ...
    var Lo = (function(e) {
        ...
        return (
            ...
            (t.prototype.shouldComponentUpdate = function(e, t) {
                return (
                    this.debug && console.log(Rt(e, this.props), Rt(t, this.state)), !_t(this.props, e, this.propEquality) ||
                    ...
                    return (
                        ...
                        (e &&
                            ...
                            (e = this.customContentInfo =
                                r({ contentKey: n.contentKey, contentVal: t[n.contentKey] },
        ...
        return (
            ...
            (t.prototype.render = function() {
                ...
                return _o(
                    ...
                    function(t) {
                        return e.children(
                            t, ["fc-" + e.viewSpec.type + "-view", "fc-view"].concat(o)
                        );
                    }
                );
            }),
                    ...
                    return _o(Oo.Consumer, null, function(n) {
                        return _o(ti, { viewSpec: n.viewSpec }, function(o, i) {
                            ...
                            return _o(
                                ...
                                function(e, t, n, r) {
                                    return _o(
                                        "div", { className: i.concat(t).join(" "), ref: e },
                                        r
                                    );
                                }
                            );
    ...
    var ai = (function() {
        ...
        return (
            ...
            (e.prototype.buildCurrentRangeInfo = function(e, t) {
                ...
                return (
                    ...
                    ((i = Vt((o = this.getFallbackDuration())).unit),
                        (a = this.buildRangeFromDuration(e, t, o, i))), { duration: o, unit: i, range: a }
                );
            }),
            ...
            (e.prototype.adjustActiveRange = function(e) {
                ...
                return (
                    ...
                    (Lt(o) < 0 && ((a = lt(a)), (a = n.add(a, o))),
                        Lt(i) > 1 && ((s = tt((s = lt(s)), -1)), (s = n.add(s, i)))), { start: a, end: s }
                );
            }),
            ...
            (e.prototype.skipHiddenDays = function(e, t, n) {
                for (
                    void 0 === t && (t = 1), void 0 === n && (n = !1); this.isHiddenDayHash[(e.getUTCDay() + (n ? t : 0) + 7) % 7];
    ...
    function fi(e, t, n, o) {
        var i = o.options,
            ...
            l = Le();
        return (
            s.fetch({ eventSource: e, range: t, isRefetch: n, context: o },
                function(n) {
                    var r = n.rawEvents;
            ...
            widgets: p.map(function(e) {
                return e.split(",").map(function(e) {
                    ...
                    if ((n = s[e]))
                        ...
                        y = Xe(
                            p.buttonTitleOverride || p.buttonTitleDefault || t.viewHint, [E, e],
                            E
                        );
                    } else if (i[e])
                        if (
    ...
    function ki(e, t) {
        for (
            var n = Ct(t.getCurrentData().eventSources), r = [], o = 0, i = e; o < i.length; o++
        ) {
                    ...
                    if (
                        ...
                        var n = {
                                ...
                                startRecur: e.startRecur ?
                                    t.createMarker(e.startRecur) : null,
                                endRecur: e.endRecur ? t.createMarker(e.endRecur) : null,
                            },
                            r = void 0;
                        return (
                            e.duration && (r = e.duration), !r &&
                            e.startTime &&
                            e.endTime &&
                            ((o = e.endTime),
                                (i = e.startTime),
        ...
        function e(e) {
            ...
            for (
                var p = {
                    ...
                    f = 0,
                    h = o.pluginHooks.contextInit; f < h.length; f++
            ) {
                (0, h[f])(p);
            }
            for (
                var v = si(o.calendarOptions, d, p),
                    ...
                    m = r(r({}, p), g),
                    y = 0,
                    E = o.pluginHooks.reducers; y < E.length; y++
            ) {
                var S = E[y];
                r(g, S(null, null, m));
            }
            ...
            (e.prototype._handleAction = function(e) {
                ...
                for (
                    var f = li(o.eventSources, e, p, c),
                        ...
                        b = r(r({}, c), S),
                        D = 0,
                        C = s.pluginHooks.reducers; D < C.length; D++
                ) {
                    var w = C[D];
                    r(S, w(o, e, b));
                }
    ...
    function Xi(e) {
        for (var t = [], n = 0, r = e; n < r.length; n++) {
            for (
                var o = r[n], i = [], a = { span: o.span, entries: [o] }, s = 0, l = t; s < l.length; s++
            ) {
                var u = l[s];
                $i(u.span, a.span) ?
                    (a = {
                ...
                (t.prototype.renderWidgetGroup = function(e) {
                    for (
                        ...
                        if ("title" === u)
                            ...
                            r.push(
                                _o(
                                    "h2", { className: "fc-toolbar-title", id: t.titleId },
                                    t.title
                                )
                            );
                        else {
            ...
            return (
                ...
                (t.prototype.render = function() {
                    ...
                    return _o(
                        ...
                        _o(
                            ca, { liquid: a, height: s, aspectRatio: e, labeledById: u },
                            this.renderView(t),
    ...
    function ma(e, t) {
        return ln(!e || t > 10 ? { weekday: "short" } :
            t > 1 ? { weekday: "short", month: "numeric", day: "numeric", omitCommas: !0 } : { weekday: "long" }
        );
    }
                    ...
                    return _o(
                        ...
                        function(e, t, n, o) {
                            return _o(
                                ...
                                _o(
                                    "div", { className: "fc-scrollgrid-sync-inner" }, !u.isDisabled &&
                                    _o(
                                        "a",
                                        r({
                                                ref: n,
    ...
    var Ta = (function() {
            ...
            return (
                (e.prototype.sliceRange = function(e) {
                    ...
                    return (r = Math.ceil(r)) <= (o = Math.floor(o)) ? { firstIndex: r, lastIndex: o, isStart: t === r, isEnd: n === o } :
                        null;
                }),
        ...
        ka = (function() {
            function e(e, t) {
                ...
                if (t) {
                    for (
                        r = i[0].getUTCDay(), n = 1; n < i.length && i[n].getUTCDay() !== r; n += 1
                    );
        ...
        xa = (function() {
            ...
            return (
                ...
                (e.prototype.sliceEventRange = function(e, t) {
                    ...
                    for (
                        var r = this.sliceRange.apply(this, o([n], t)), i = 0, a = r; i < a.length; i++
                    ) {
                        var s = a[i];
                        (s.eventRange = e),
    ...
    function Ba(e) {
        for (
            var t = 0, n = 0, r = De(e, ".fc-scrollgrid-shrink"); n < r.length; n++
        ) {
            var o = r[n];
            t = Math.max(t, Je(o));
        }
    ...
    function Ga(e, t, n, r) {
        ...
        return "function" == typeof t.content ?
            ...
            _o(
                ...
                n.tableColGroupNode,
                _o(
                    r ? "thead" : "tbody", { role: "presentation" },
    ...
    var ts = (function(e) {
        ...
        return (
            ...
            (t.prototype.render = function() {
                ...
                for (
                    var u, c = i.length, d = 0, p = [], f = [], h = []; d < c && "header" === (u = i[d]).type;
                ...
                var v = !Qr(),
                    g = { role: "rowgroup" };
                return _o(
                    "table", { role: "grid", className: l.join(" "), style: { height: t.height } },
            ...
            (t.prototype.renderChunkTd = function(e, t, n, r) {
                ...
                return _o(
                    r ? "th" : "td", { ref: n.elRef, role: "presentation" },
                    _o(
                        "div", {
            ...
            return (
                    ...
                    return Io(
                        _o(
                            ...
                            r({
                                ...
                                o.extraAttrs, { ref: this.handleRootEl }
                            ),
                            _o(
                                "div", {
                                ...
                                _o(
                                    "span", { className: "fc-popover-title", id: i.titleId },
                                    o.title
                                ),
                                _o("span", {
                ...
                (t.prototype.updateSize = function() {
                    var e = this.context.isRtl,
                        ...
                        i = (function(e) {
                            for (
                                var t = mo(e), n = e.getBoundingClientRect(), r = 0, o = t; r < o.length; r++
                            ) {
            ...
            return (
                    ...
                    return _o(
                        ...
                        function(e, t, n) {
                            return _o(
                                ...
                                _o(
                                    ss, { date: o, dateProfile: a, todayRange: i },
                                    function(e, t) {
                                        return (
                                            t &&
                                            _o(
                                                "div", { className: "fc-more-popover-misc", ref: e },
                                                t
                                            )
                                        );
                                    }
                ...
                (t.prototype.queryHit = function(e, t, n, o) {
                    ...
                    return e >= 0 && e < n && t >= 0 && t < o ? {
                            ...
                            dateSpan: r({ allDay: !0, range: { start: a.startDate, end: a.endDate } },
                                a.extraDateSpan
                            ),
                            dayEl: i,
                                ...
                                _o(
                                    ...
                                    function(t, n, i, a) {
                                        return (
                                            ...
                                            o.setHeight(n),
                                            _o(
                                                Zo.Provider, { value: o.customContentRenderId },
        ...
        return (
            ...
            (t.prototype.setClassNames = function(e) {
                if (!Gt(e, this.currentClassNames)) {
                    for (
                        var t = this.el.classList, n = 0, r = this.currentClassNames; n < r.length; n++
                    ) {
                        var o = r[n];
                        t.remove(o);
                    }
            ...
            return (
                (e.prototype.destroy = function() {
                    this.containerEl.removeEventListener(
                        ...
                        this.containerEl.removeEventListener(
                            "touchstart",
                            this.handleTouchStart, { passive: !0 }
                        ),
                        (Rs -= 1) ||
                    ...
                    this.isDelayEnded &&
                        ...
                        ((this.pointer.wasTouchScroll && !this.touchScrollAllowed) ||
                            ((this.isDragging = !0),
                                ...
                                this.emitter.trigger("dragstart", e), !1 === this.touchScrollAllowed &&
        ...
        As = (function() {
            ...
            return (
                ...
                (e.prototype.computeLeft = function() {
                    for (
                        var e = this.origRect.left, t = 0, n = this.scrollCaches; t < n.length; t++
                    ) {
                        var r = n[t];
                ...
                (e.prototype.computeTop = function() {
                    for (
                        var e = this.origRect.top, t = 0, n = this.scrollCaches; t < n.length; t++
                    ) {
                        var r = n[t];
                ...
                (e.prototype.isWithinClipping = function(e, t) {
                    for (
                        var n, r, o = { left: e, top: t }, i = 0, a = this.scrollCaches; i < a.length; i++
                    ) {
                        var s = a[i];
                        if (
                            ((n = s.getEventTarget()),
    ...
    function Ws(e, t) {
        for (
            var n, o, i = {}, a = 0, s = t.pluginHooks.datePointTransforms; a < s.length; a++
        ) {
            var l = s[a];
            r(i, l(e, t));
        }
                    ...
                    if (e) {
                        ...
                        i === a || (d.editable && d.droppable) ?
                            (s = (function(e, t, n) {
                                ...
                                for (
                                    var u = { datesDelta: l, standardProps: s }, c = 0, d = n; c < d.length; c++
                                ) {
                                    (0, d[c])(u, e, t);
                                }
                                return u;
    ...
    var zs = (function(e) {
        function t(t) {
            ...
            (n.handlePointerDown = function(e) {
                ...
                n.dragging.setIgnoreMove(!n.component.isValidSegDownEl(e.origEvent.target) ||
                    (e.isTouch &&
                            ...
                            ((s = (function(e, t, n) {
                                    for (
                                        var o = r({}, t.leftoverProps),
                                            i = 0,
                                            a = n.pluginHooks.externalDefTransforms; i < a.length; i++
                                    ) {
                                        var s = a[i];
                                        r(o, s(e, t));
                                    }
                ...
                (t.prototype.renderSimpleLayout = function(e, t) {
                    ...
                    return (
                        ...
                        _o(ti, { viewSpec: r.viewSpec }, function(e, t) {
                            return _o(
                                "div", { ref: e, className: ["fc-daygrid"].concat(t).join(" ") },
                                _o(ts, {
                ...
                return _o(
                    ...
                    function(n, o) {
                        return (
                            (o || e.forceDayTop) &&
                            _o(
                                "div", { className: "fc-daygrid-day-top", ref: n },
                                _o(
                                    "a",
                                    r({ id: e.dayNumberId, className: "fc-daygrid-day-number" },
                                        t
                                    ),
                                    o || _o(xo, null, " ")
                                )
            ...
            var p = s.addSegs(l),
                f = (function(e, t, n) {
                    for (
                        ...
                        for (
                            var l = r[s], u = [], c = 0, d = 0, p = 0, f = l; p < f.length; p++
                        ) {
                            var h = t[(y = f[p]).index];
                            u.push({
                                    seg: hl(h, s, s + 1, n),
                ...
                (t.prototype.renderFillSegs = function(e, t) {
                    ...
                    if (a)
                        for (var l = 0, u = e; l < u.length; l++) {
                            var c = u[l],
                                d = n ? { right: 0, left: a.lefts[c.lastCol] - a.lefts[c.firstCol] } : {
                                    left: 0,
        ...
        return (
            ...
            (t.prototype.prepareHits = function() {
                ...
                (this.colPositions = new So(
                    this.rootEl,
                    this.rowRefs.currentMap[0].getCellEls(), !0, !1
                ));
            }),
            (t.prototype.queryHit = function(e, t) {
                ...
                if (null != a && null != i) {
                    ...
                    return {
                        ...
                        dateSpan: r({ range: this.getCellRange(a, i), allDay: !0 },
                            s.extraDateSpan
                        ),
        ...
        wl = (function(e) {
            ...
            return (
                ...
                (t.prototype.getKeysForEventDef = function(e) {
                    return e.allDay ?
                        Kn(e) ? ["timed", "allDay"] : ["allDay"] : ["timed"];
                }),
                t
            );
        })(to),
                ...
                return (
                    ...
                    (t.renderHeadAxis = function(e, n) {
                        ...
                        return o.weekNumbers && "day" === e ?
                            _o(
                                fs, { date: i.start, defaultFormat: xl },
                                function(e, t, o, i) {
                                    return _o(
                                        "th", {
                                            ref: e,
                            ...
                            _o(
                                "th", { "aria-hidden": !0, className: "fc-timegrid-axis" },
                                _o("div", {
            ...
            return (
                ...
                (t.prototype.renderSimpleLayout = function(e, t, n) {
                    ...
                    return (
                        ...
                        _o(
                            ti, { viewSpec: r.viewSpec, elRef: this.rootElRef },
                            function(e, t) {
                                return _o(
                                    "div", { className: ["fc-timegrid"].concat(t).join(" "), ref: e },
                                    _o(ts, {
                ...
                (t.prototype.renderHScrollLayout = function(e, t, n, r, o, i, a) {
                    ...
                    return (
                        ...
                        _o(
                            ti, { viewSpec: u.viewSpec, elRef: this.rootElRef },
                            function(e, t) {
                                return _o(
                                    "div", { className: ["fc-timegrid"].concat(t).join(" "), ref: e },
                                    _o(l, {
                ...
                (t.prototype.getAllDayMaxEventProps = function() {
                    var e = this.context.options,
                        ...
                        n = e.dayMaxEventRows;
                    return (
                        (!0 !== t && !0 !== n) || ((t = void 0), (n = 5)), { dayMaxEvents: t, dayMaxEventRows: n }
                    );
                }),
                t
            );
                ...
                (t.prototype.render = function() {
                    ...
                    return _o(
                        ...
                        e.slatMetas.map(function(i, a) {
                            ...
                            return _o(
                                "tr", { key: i.key, ref: o.createRef(i.key) },
                                e.axis && _o(_l, r({}, i)),
                                _o(
                                    Yo, {
                                        hookProps: s,
                ...
                return _o(
                    ...
                    function(n, r, o, i, a, s, l, u) {
                        return _o(
                            ...
                            _o(
                                "div", { ref: o, className: "fc-timegrid-more-link-inner fc-sticky" },
                                i
                            )
                        );
                    }
    ...
    function Vl(e, t) {
        ...
        for (
            var n = e.level, r = e.lateralStart, o = e.lateralEnd, i = r, a = []; i < o;
    ...
    function Xl(e, t) {
        ...
        return _o(
            ...
            e.map(function(e) {
                ...
                return _o(
                    "div", { key: t, style: { visibility: l[t] ? "hidden" : "" } },
                    _o(
                        ql,
                        r({
                                seg: e,
        ...
        return (
            ...
            (t.prototype.queryHit = function(e, t) {
                ...
                if (null != p && null != f) {
                    ...
                    return {
                        dateProfile: s,
                        dateSpan: r({ range: { start: b, end: D }, allDay: !1 },
                            h.extraDateSpan
                        ),
                        dayEl: a.els[p],
                        rect: {
    ...
    function uu(e) {
        return _o(
            ...
            _o(
                "a",
                r({ "aria-hidden": !0, className: "fc-list-day-side-text" },
                    e.sideNavLinkAttrs
                ),
                e.sideText
            )
                    ...
                    return _o(
                        ...
                        function(e, r, l, u, c) {
                            return _o(
                                ...
                                _o(
                                    "td", { "aria-hidden": !0, className: "fc-list-event-graphic" },
                                    _o("span", {
        ...
        return (
            ...
            (t.prototype.render = function() {
                var e = this,
                    ...
                    r = [
                        "fc-list",
                        n.theme.getClass("table"), !1 !== n.options.stickyHeaderDates ? "fc-list-sticky" : "",
                    ],
                ...
                return _o(
                    ti, { viewSpec: n.viewSpec, elRef: this.setRootEl },
                    function(n, o) {
                        return _o(
                            "div", { ref: n, className: r.concat(o).join(" ") },
                            _o(
                                Va, {
            ...
            (t.prototype.renderEmptyMessage = function() {
                ...
                return _o(
                    ...
                    function(e, t, n, r) {
                        return _o(
                            "div", { className: ["fc-list-empty"].concat(t).join(" "), ref: e },
                ...
                return _o(Ca, { unit: "day" }, function(e, n) {
                    for (var a = [], d = 0; d < c.length; d += 1) {
                        ...
                        if (p) {
                            ...
                            for (
                                var v = 0, g = (p = tr(p, i.eventOrder)); v < g.length; v++
                            ) {
                                var m = g[v];
                                a.push(
                                    _o(
                    ...
                    return _o(
                        "table", { className: "fc-list-table " + o.getClass("table") },
                        _o(
                            "thead",
                            null,
                            _o(
    ...
    function vu(e) {
        for (
            var t = lt(e.renderRange.start), n = e.renderRange.end, r = [], o = []; t < n;
